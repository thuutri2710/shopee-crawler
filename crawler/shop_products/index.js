...
const fetchProductsLimit = async (shopId, newest) => {
  const res = await fetch(
    `https://shopee.vn/api/v4/search/search_items/?by=pop&entry_point=ShopByPDP&limit=30&match_id=${shopId}&newest=${newest}&order=desc&page_type=shop&pdp_l3cat=10919&version=2`,
    {
      headers: {
        accept: "*/*",
